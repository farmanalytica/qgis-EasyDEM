...
class AuthCtrl:
    ...
    def _on_status_ready(self, state: str):
        ...
        self.dialog.set_auth_state(
            "authenticated" if state == "authenticated" else state
        )
    ...
    def handle_authentication(self):
        ...
        self._auth_worker = AuthWorker(self.gee_service, project_id)
    ...
    def _navigate_to_dem(self):
        """After auth, load datasets for the current AOI and show the DEM page."""
        self.dialog.btn_go_to_aoi.click()
